 ...
 * La broche 2 est utilisé pour 'recevoir' des requête (RX)
 * Le broche 3 est utiliser pour 'renvoyer' les retours des requêtes demandé. (TX)
 */
...
#ifdef ARDUINO_AVR_UNO
//Permet de définir Serial1 uniquement si nous somme sur une carte arduino uno.
SoftwareSerial Serial1(PIN_SERIAL_RX, PIN_SERIAL_TX);
#endif
